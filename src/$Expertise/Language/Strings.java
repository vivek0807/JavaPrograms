...
/*
Strings created with Object creation or using new keyword are stored in Heap Area.
-- When we create String with direct assignment the String is stored in String Pool
