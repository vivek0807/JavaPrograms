...
PREDICATES HAVE some inbuilt functions like Test, Negate isEqual or and can return Boolean
CHAINING METHODS using AND,OR methods
There return type is also a functional Interface
<h2>As functional interfaces allow only one abstract method, the lambda expression defined is directly assigned the definition</h2>
Consumers- These are functional interfaces with default method as ACCEPT. They can be assigned any
